...
export function SectionEmojiVisual({ emoji, size = "header", className }: SectionEmojiVisualProps) {
  ...
  return (
    <div
      className={cn(
        "flex shrink-0 items-center justify-center rounded-2xl border border-gold/30 bg-gold/10 leading-none shadow-[0_8px_30px_rgba(0,0,0,0.35)]",
        size === "header"
          ? isWide
