...
const translations = {
  en: {
    ...
    iAmEntrepreneur: "Cotiser",
    iAmEntrepreneurDesc:
      "Support the Manden Empire with your contribution.",
    tombouctou: "Tombouctou",
    tombouctouDesc: "Discover Tombouctou, the city of 333 saints and a pillar of Manden heritage.",
    followUs: "Follow us",
    facebook: "Facebook",
    byCountry: "Federation",
    byCountryDesc: "Browse the federation by alphabetical order and add relevant information over time.",
    ...
    byAffiliationDesc: "Browse affiliations within the Manden network.",
  ...
  fr: {
    ...
    iAmEntrepreneur: "Cotiser",
    iAmEntrepreneurDesc:
      "Soutenez l'Empire Manden avec votre contribution.",
    tombouctou: "Tombouctou",
    tombouctouDesc: "Découvrez Tombouctou, la ville des 333 saints et un pilier du patrimoine du Manden.",
    followUs: "Suivez-nous",
    facebook: "Facebook",
    byCountry: "Fédération",
    byCountryDesc: "Parcourez la fédération par ordre alphabétique et ajoutez les informations pertinentes au fil du temps.",
    byOrganization: "Organisation",
    byOrganizationDesc: "Parcourez les organisations affiliées au réseau du Manden.",
    byAffiliation: "Affiliation",
    byAffiliationDesc: "Parcourez les affiliations au sein du réseau du Manden.",
