...
const translations = {
  en: {
    ...
    byCountryDesc: "Medieval map of the Manden federation and N'Ko letter tiles for each region code.",
  ...
  fr: {
    ...
    byCountryDesc: "Carte médiévale de la fédération du Manden et tuiles N'Ko pour chaque code de région.",
