...
const translations = {
  en: {
    ...
    tombouctouGalleryTimeline: "A Visual Journey",
    tombouctouGalleryCollection: "Heritage Collection",
    followUs: "Follow us",
    facebook: "Facebook",
    youtube: "YouTube",
    linkedin: "LinkedIn",
    ...
    footerNewsletter: "Community",
    footerNewsletterDesc:
      "Stay connected with the Manden community. Receive updates on heritage, governance, and institutional news.",
    footerEmailPlaceholder: "Your email address",
    footerSubscribe: "Subscribe",
    footerSubscribeSuccess: "Thank you. We will keep you informed.",
    footerMission:
      "Sanun Jara facilitates the reincarnation of Manden Mansaya — preserving ancestral values, institutions, and unity across the Manden federation.",
    footerBackToTop: "Back to top",
    footerSocialSoon: "More channels coming soon",
    footerDevelopedBy: "Developed by the Sanun Jara Computer Science Team",
  ...
  fr: {
    ...
    disciplinaryCommittee: "Comité de discipline",
    ...
    tombouctouGalleryTimeline: "Un voyage visuel",
    tombouctouGalleryCollection: "Collection patrimoniale",
    followUs: "Suivez-nous",
    facebook: "Facebook",
    youtube: "YouTube",
    linkedin: "LinkedIn",
    footerQuickLinks: "Liens utiles",
    footerNavigation: "Navigation",
    footerContact: "Contact",
    footerContactUs: "Nous contacter",
    footerNewsletter: "Communauté",
    footerNewsletterDesc:
      "Restez connecté à la communauté du Manden. Recevez des nouvelles sur le patrimoine, la gouvernance et la vie institutionnelle.",
    footerEmailPlaceholder: "Votre adresse e-mail",
    footerSubscribe: "S'abonner",
    footerSubscribeSuccess: "Merci. Nous vous tiendrons informé.",
    footerMission:
      "Sanun Jara facilite la réincarnation du Manden Mansaya — en préservant les valeurs ancestrales, les institutions et l'unité de la fédération du Manden.",
    footerBackToTop: "Retour en haut",
    footerSocialSoon: "D'autres canaux bientôt disponibles",
    footerDevelopedBy: "Développé par l'équipe informatique de Sanun Jara",
