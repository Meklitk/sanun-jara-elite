...
const translations = {
  en: {
    ...
    byCountryDesc: "Medieval map of the Manden federation. Click the map to enlarge it. N'Ko letter tiles appear for each region code below.",
  ...
  fr: {
    ...
    byCountryDesc: "Carte médiévale de la fédération du Manden. Cliquez sur la carte pour l'agrandir. Les tuiles N'Ko de chaque région apparaissent ci-dessous.",
